...
/* 手机端其它收支 — 客户端交互组件
 * 首屏记录（当前月份）由服务端 page.tsx 查询后传入，切换月份后仍走客户端加载 */
export default function MobileOtherContent({
  initialMonth,
  initialRecords,
}: {
  initialMonth: string;
  ...
  const [records, setRecords] = useState<记录[]>(initialRecords);
