  ...
  return (
    <div className="flex flex-col h-full">
      <div className="sticky top-0 z-40 bg-white border-b border-gray-200 flex items-center justify-between px-4 h-12 shrink-0">
        <h1 className="text-base font-semibold text-gray-900">手机领料</h1>
          ...
          orders.map((order: any) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs px-2 py-0.5 rounded bg-pink-50 text-pink-700">
                  {order.status === "pending_repair" ? "待维修" : "维修中"}
                </span>
              </div>
