...
export default function SupplierReturnsContent({ initialRecords }: { initialRecords: SupplierReturnRecord[] }) {
  const supabase = useMemo(() => createClient(), []);
  const [records, setRecords] = useState<SupplierReturnRecord[]>(initialRecords);
  const [allRecords, setAllRecords] = useState<SupplierReturnRecord[]>(initialRecords);
