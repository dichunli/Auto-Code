      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 max-w-2xl">
        <div className="space-y-6">
          <div>
            ...
            <input required className="w-full px-3 py-2 border border-gray-300 rounded-lg" placeholder="如：保养、机修、钣金" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} />
          </div>
