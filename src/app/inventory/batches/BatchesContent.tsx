...
/* 批次管理列表 — 客户端交互组件
 * 首屏数据由服务端 page.tsx 查询后通过 initialBatches 传入，仅保留前端搜索过滤 */
...
export default function BatchesContent({ initialBatches }: { initialBatches: BatchRecord[] }) {
  const [batches] = useState<BatchRecord[]>(initialBatches);
