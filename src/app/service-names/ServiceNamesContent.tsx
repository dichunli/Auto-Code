...
export default function ServiceNamesContent({ initialData }: { initialData: ServiceName[] }) {
  const supabase = useMemo(() => createClient(), []);
  const [items, setItems] = useState<ServiceName[]>(initialData);
