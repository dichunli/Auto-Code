...
export default function PromotionOverviewContent({ initialStatusList }: { initialStatusList: 员工状态[] }) {
  const supabase = useMemo(() => createClient(), []);
  /* 首屏数据由服务端传入；loading 仅用于发起晋级后的客户端重查 */
  const [statusList, setStatusList] = useState<员工状态[]>(initialStatusList);
