...
export default function EditMechanicLevelPage() {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      if (data) {
        ...
        setCoefficient(String(data.share_coefficient ?? "1.00"));
        setCommissionWeight(String(data.commission_weight ?? "1.00"));
  ...
  return (
    <div className="max-w-lg mx-auto">
      <PageHeader title="编辑技师等级" description="修改等级信息" />
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              placeholder="数字越小越靠前"
            />
            <p className="text-xs text-gray-400 mt-1">数字越小，在列表中显示越靠前</p>
          </div>
