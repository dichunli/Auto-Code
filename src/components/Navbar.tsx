...
const navItems: NavItem[] = [
  ...
  { href: "/appointments", label: "客户预约" },
  {
    ...
    children: [
      ...
      { href: "/inventory/checks", label: "库存盘点" },
      { href: "/inventory/scrap", label: "报废出库" },
      { href: "/inventory/transfer", label: "仓位调拨" },
  ...
  },
  {
    ...
    label: "行为考核",
    children: [
      { href: "/behavior/items", label: "行为项目" },
      { href: "/behavior/tasks", label: "考核任务" },
      { href: "/behavior/score", label: "行为打分" },
      { href: "/behavior/checks", label: "今日考核" },
    ],
  },
  ...
  { href: "/operation-logs", label: "操作日志" },
  {
    ...
    children: [
      ...
      { href: "/settings/error-logs", label: "错误日志" },
...
export function Navbar() {
  ...
  return (
    <>
      {/* 移动端顶部条 */}
      <div
        className="md:hidden fixed top-0 left-0 right-0 min-h-14 bg-white border-b border-gray-200 z-50 flex items-center justify-between px-4"
        style={{ paddingTop: "env(safe-area-inset-top)" }}
      >
        <Link href="/m/" className="flex items-center gap-2 py-2">
        ...
        {pathname === "/m/reception" && (
          <Link
            ...
            className="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 active:bg-blue-800 min-h-[36px] flex items-center"
          >
            + 新建
          </Link>
        )}
